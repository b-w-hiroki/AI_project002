...
export const PORTRAIT_BLUEPRINT = {
  title: {
    hud: { x: 15, y: 11, width: 420, height: 99 },
    rail: { x: 12, y: 104, width: 70, height: 354 },
    notice: { x: 29, y: 562, width: 314, height: 38 },
    request: { x: 18, y: 600, width: 414, height: 112 },
    navigation: { x: 8, y: 724, width: 434, height: 68 },
  },
  choice: {
    hud: { x: 15, y: 9, width: 420, height: 60 },
    request: { x: 138, y: 81, width: 304, height: 192 }, // includes the speech tail
    playerPortrait: { x: 0, y: 284, width: 270, height: 270 },
  ...
  final: {
    ...
    growth: { x: 40, y: 535, width: 370, height: 133 },
    replay: { x: 45, y: 679, width: 360, height: 80 },
  },
} as const;
