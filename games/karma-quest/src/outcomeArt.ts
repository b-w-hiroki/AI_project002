...
export const OUTCOME_ART: Readonly<Record<string, readonly [string, string]>> = {
  ...
  merchant_monster: ["kq-outcome-merchant_monster-accept-v2", "kq-outcome-merchant_monster-decline-v1"],
  merchant_toll: ["kq-outcome-merchant_toll-accept-v1", "kq-outcome-merchant_toll-decline-v1"],
  outlaw_gold: ["kq-outcome-outlaw_gold-accept-v2", "kq-outcome-outlaw_gold-decline-v1"],
  outlaw_fight: ["kq-outcome-outlaw_fight-accept-v1", "kq-outcome-outlaw_fight-decline-v1"],
  mage_stone: ["kq-outcome-mage_stone-accept-v2", "kq-outcome-mage_stone-decline-v1"],
