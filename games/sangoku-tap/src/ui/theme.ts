...
export function drawPanel(
  ...
  // 武将札のような上下アクセント。
  g.lineStyle(2, THEME.accent, 0.76);
  g.lineBetween(x - w / 2 + 12, y - h / 2 + 1, x - w / 2 + 42, y - h / 2 + 1);
  g.lineBetween(x + w / 2 - 42, y + h / 2 - 1, x + w / 2 - 12, y + h / 2 - 1);
  return g;
}
